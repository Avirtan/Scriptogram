...
export interface IInputMediaVideo {
  ...
  /**
   * Опционально. Подпись к видео, 0-1024 символа после разбора сущностей.
   *
  ...
  /**
   * Опционально. Режим разбора сущностей в подписи к видео. См. варианты форматирования для получения дополнительной информации.
   *
  ...
  /**
   * Опционально. Продолжительность видео в секундах.
   *
