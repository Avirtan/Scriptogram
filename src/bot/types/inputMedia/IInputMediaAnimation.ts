...
export interface IInputMediaAnimation {
  /**
   * Тип результата, должен быть "animation".
   *
   ...
   * Обложки нельзя повторно использовать, и их можно загрузить только как новый файл,
   * поэтому можно передать "attach://<file_attach_name>", если обложка была загружена с использованием multipart/form-data под <file_attach_name>.
   *
  ...
  /**
   * Опционально. Подпись к анимации, 0-1024 символа после разбора сущностей.
   *
  ...
  /**
   * Опционально. Режим разбора сущностей в подписи к анимации. См. варианты форматирования для получения дополнительной информации.
   *
  ...
  /**
   * Опционально. Продолжительность анимации в секундах.
   *
